...
# PMcGiffin, 5.22.22, Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        if task in table_lst:
            table_lst.remove(task)
        return list_of_rows
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        row_dic = {"Task": strTask, "Priority": strPriority}
        for row in table_lst:
...
Processor.read_data_from_file("ToDoFile.txt", table_lst)  # read file data
